...
pub(crate) fn load_stdlib(context: &mut Rant)
{
  ...
  load_funcs!(
    // General functions
    alt, call, concat, either, len, get_type as "type", seed, nop, resolve, fork, unfork, try_ as "try",
    ...
    assoc, clear, has, keys, index_of as "index-of", insert, last_index_of as "last-index-of", list, nlist, remove, sift, sifted, squish, squished, take, translate,
